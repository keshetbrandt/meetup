...
def sign_up(user_email, first_name, last_name, availability = None):
    ...
    new_user = user(user_email, first_name, last_name, get_google_calendar_cred() , availability)
...
# sign_up("js1546186@gmail.com", "John", "Simth", availability = None)
